...
def create_sql_db():
    """Creates SQL database, tables and inserts records."""
...
def create_query_engine(engine):
    """Setup SQL Query engine tool and Llama Index"""
...
# Create an agent around query engines
...
def create_workflow():
    ...
    sql_tool, llama_cloud_tool = create_query_engine(engine)
