...
class RouterOutputAgentWorkflow(Workflow):
    def __init__(self,
        ...
        self.llm: LLM = llm or Gemini()  # Initialize Gemini LLM
...
# Example: Define the tools used in the workflow
from llama_index.core.tools import FunctionTool

async def sample_tool_function(input_text: str) -> str:
    """Example tool function that returns input text."""
    return f"Processed: {input_text}"

sql_tool = FunctionTool.from_defaults(
    name="SQL_Query_Tool",
    fn=sample_tool_function,
)

llama_cloud_tool = FunctionTool.from_defaults(
