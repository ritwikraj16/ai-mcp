...
from .models import PatientInfo, ConditionInfo, EncounterInfo, MedicationInfo, ConditionBundles

def parse_synthea_patient(file_path: str, filter_active: bool = True) -> PatientInfo:
    """Parse a Synthea-generated FHIR Bundle into a PatientInfo object."""
    ...
    # Parse encounters
    def get_encounter_date(enc: Dict[str, Any]) -> datetime:
