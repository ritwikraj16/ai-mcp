...
from .data_models import PatientInfo, ConditionInfo, EncounterInfo, MedicationInfo

def parse_synthea_patient(file_path: str, filter_active: bool = True) -> PatientInfo:
    """
    Parse a Synthea-generated FHIR patient bundle and extract relevant information.
    
    Args:
        file_path: Path to the JSON file containing the FHIR bundle
        filter_active: If True, only include active conditions
        
    Returns:
        PatientInfo object containing structured patient data
    """
