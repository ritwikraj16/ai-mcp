...
from tools import get_sql_tool, get_llama_cloud_tool
...
wf = RouterOutputAgentWorkflow(tools=[get_sql_tool(), get_llama_cloud_tool()], verbose=True, timeout=120)

async def get_response(self, message: str) -> str:
    """Runs the workflow and returns the response as a string."""
